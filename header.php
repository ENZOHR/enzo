				...
				<div class="container">
					...
					<nav>
						<ul class="nav nav-pills nav-top">
							...
							<li class="logged">
								<span>Dobrodošli, <?=$fgmembersite->getFullName($_SESSION['membership'],$_SESSION['id']);?></span>
							</li>
							<? } ?>
						</ul>
					</nav>
					...
					<div class="container">
						<nav class="nav-main mega-menu">
							<ul class="nav nav-pills nav-main" id="mainMenu">
								...
								<? } else {
									if($fgmembersite->getMembershipType() === 'agent'){	?>	
								<li><a href="<?=$site_url;?>register_member.php">Registracija certifikatora</a></li>	
								<?	}	?>
								<li><a href="<?=$site_url;?>account_<?=$fgmembersite->getMembershipType();?>.php">Korisnički račun</a></li>
